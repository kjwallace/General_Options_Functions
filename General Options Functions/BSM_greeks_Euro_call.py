...
from BSM_valuation import d1f, N, dN
...
def BSM_delta(St, K, t, T, r, sigma, opt_type = 'C'):
    '''BSM DELTA of Euro call option.
...
def BSM_gamma(St, K, t, T, r, sigma, opt_type = 'C'):
...
def BSM_theta(St, K, t, T, r, sigma, opt_type = 'C'):
...
def plot_greeks(function, greek):
    ...
    V = np.zeros((len(tlist), len(klist)), dtype=np.float64)
